...
createKEGGdb::create_kegg_db('set')
install.packages("./KEGG.db", repos=NULL)
...
## Bar Plot
library(enrichplot)
barplot(kk, showCategory=5) + ggtitle("barplot for P_G core-SNP")
...
## Dot plot
dotplot(kk, showCategory=30) + ggtitle("dotplot for P_G core-SNP")
